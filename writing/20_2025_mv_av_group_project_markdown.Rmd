...
```
The Plot is pretty cool, but "temperate no dry season hot summer" (tnds) has
too many on the x-axis. It would be nice to stretch that across the top
and then tile everything else. Try the "egg" ggplot extension.
1) Break up the above plot into separate plots
2) Use ggarange as described in gthub.com/jwding/egg
