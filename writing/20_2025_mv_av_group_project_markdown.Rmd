...
consist_plot <- foo %>% ggplot(aes(x = consistency, y = accuracy, colour = name)) +
  ...
  annotate("text", x = .13, y = .335, label = "italic(R)^2 == .035",
           parse = TRUE, size = 5, angle = 6.5) +
  labs(x = "Early Spring Consistency at Prognoticator Location",
