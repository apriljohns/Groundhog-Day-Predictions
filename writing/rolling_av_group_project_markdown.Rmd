...
#the data will need to be in the same format as UKLungDeaths, so each groundhog
#will need to have its "is_correct" column vectorized. To do that, first
#pivot wider.
