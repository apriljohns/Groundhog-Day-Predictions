...
quartile_plot <- ggplot() +
  ...
  labs(
    title = "Early Spring Consistency (Q1 = least consistent 25%)",
    x = " ",
    y = "Proportion\n\n",
    fill = "Metric"
  ) +
  ...
  theme(
    ...
    legend.position = c(0.5, -.25), legend.direction = "horizontal",
