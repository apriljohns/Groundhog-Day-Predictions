...
groundhog_range <- st_read("../data/shape_files/groundhog_range.shp", quiet = TRUE) 

groundhog_map <- groundhogs_raw %>%
...
very consistent climate. I'm lookin' at you, "Dunkirk Dave!" To quantify weather consistency,
...
To assess the accuracy of prognosticators in the context of any advantage that climate
consistency confers, we calcualated a corrected accuracy value with the formula:
