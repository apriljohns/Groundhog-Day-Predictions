...
# I'm commenting this out since it only needs to be run once, 
# but wanted to show you where it came from 
...
- Therefore, we want the compute average temperature in the range: DOY-1: 357-366 (to include leap years), DOY: 1-33
